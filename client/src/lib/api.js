...
export const registerUser = async (newUser) =>{
  const res = await axios.post(`${BASE_URL}/register`, newUser); // newUser => post Data
  return res.data;
}

export const loginUser = async (userCreds) => {
  const res = await axios.post(`${BASE_URL}/login`, userCreds); // newUser => post Data
  return res.data;
}
